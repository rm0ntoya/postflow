...
function CardProvider({ children }: { children: React.ReactNode }) {
  ...
  const cards: Card[] = [
    { id: "1", imageUrl: "/img/viral-27.jpg", alt: "Imagem viral gerada pelo NovaCraft", title: "Impacto visual" },
    { id: "2", imageUrl: "/img/viral-33.jpg", alt: "Imagem viral gerada pelo NovaCraft", title: "Cena impossível" },
    { id: "3", imageUrl: "/img/viral-32.jpg", alt: "Imagem viral gerada pelo NovaCraft", title: "Mistério editorial" },
    { id: "4", imageUrl: "/img/viral-26.jpg", alt: "Imagem viral gerada pelo NovaCraft", title: "Quebra de padrão" },
    { id: "5", imageUrl: "/img/viral-18.jpg", alt: "Imagem viral gerada pelo NovaCraft", title: "Reação humana" },
    { id: "6", imageUrl: "/img/viral-30.jpg", alt: "Imagem viral gerada pelo NovaCraft", title: "Prova visual" },
    { id: "7", imageUrl: "/img/viral-24.jpg", alt: "Imagem viral gerada pelo NovaCraft", title: "Narrativa em close" },
    { id: "8", imageUrl: "/img/viral-25.jpg", alt: "Imagem viral gerada pelo NovaCraft", title: "Objeto símbolo" },
    { id: "9", imageUrl: "/img/viral-19.jpg", alt: "Imagem viral gerada pelo NovaCraft", title: "Tensão silenciosa" },
    { id: "10", imageUrl: "/img/viral-10.jpg", alt: "Imagem viral gerada pelo NovaCraft", title: "Memória visual" },
    { id: "11", imageUrl: "/img/viral-04.jpg", alt: "Imagem viral gerada pelo NovaCraft", title: "Luz de descoberta" },
    { id: "12", imageUrl: "/img/viral-08.jpg", alt: "Imagem viral gerada pelo NovaCraft", title: "Detalhe magnético" },
    { id: "13", imageUrl: "/img/viral-05.jpg", alt: "Imagem viral gerada pelo NovaCraft", title: "Energia cinética" },
    { id: "14", imageUrl: "/img/viral-38.jpg", alt: "Imagem viral gerada pelo NovaCraft", title: "Antes e depois" },
    { id: "15", imageUrl: "/img/viral-21.jpg", alt: "Imagem viral gerada pelo NovaCraft", title: "Atenção imediata" },
    { id: "16", imageUrl: "/img/viral-14.jpg", alt: "Imagem viral gerada pelo NovaCraft", title: "Construção de desejo" },
    { id: "17", imageUrl: "/img/viral-16.jpg", alt: "Imagem viral gerada pelo NovaCraft", title: "Ponto de virada" },
    { id: "18", imageUrl: "/img/viral-23.jpg", alt: "Imagem viral gerada pelo NovaCraft", title: "Imagem gancho" },
    { id: "19", imageUrl: "/img/viral-31.jpg", alt: "Imagem viral gerada pelo NovaCraft", title: "Conflito visual" },
    { id: "20", imageUrl: "/img/viral-36.jpg", alt: "Imagem viral gerada pelo NovaCraft", title: "Fechamento forte" },
  ];
